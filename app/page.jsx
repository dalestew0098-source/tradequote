...
<section style="background:#111418;border-top:1px solid #1E1E2E;border-bottom:1px solid #1E1E2E;padding:72px 24px;">
  <div style="max-width:640px;margin:0 auto;">
    ...
    <p style="font-size:15px;color:#888;line-height:1.65;max-width:480px;margin-bottom:28px;">
      Unlimited documents, sync across all your devices, and send invoices directly by email. Join the waitlist and lock in the launch price before it goes up.
    </p>
    <form action="https://formspree.io/f/mbdbqkgp" method="POST" style="display:flex;border:1px solid #2A2A3E;">
      <input type="hidden" name="product" value="TradeQuote"/>
      <input type="email" name="email" placeholder="your@email.com" required style="flex:1;background:#12121E;border:none;border-right:1px solid #2A2A3E;color:#FAFAF8;padding:14px 16px;font-size:14px;min-width:0;"/>
      <button type="submit" style="background:#E8440A;border:none;color:#fff;font-weight:800;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;padding:0 24px;cursor:pointer;white-space:nowrap;">JOIN WAITLIST</button>
    </form>
    <div style="display:flex;border:1px solid #1E1E2E;border-top:none;">
      <div style="flex:1;background:#12121E;padding:12px 14px;border-right:1px solid #1E1E2E;"><div style="font-size:8px;color:#E8440A;letter-spacing:0.16em;margin-bottom:4px;text-transform:uppercase;">PRICE</div><div style="font-size:12px;color:#C8C8D8;">$39/mo launch price</div></div>
      <div style="flex:1;background:#12121E;padding:12px 14px;border-right:1px solid #1E1E2E;"><div style="font-size:8px;color:#E8440A;letter-spacing:0.16em;margin-bottom:4px;text-transform:uppercase;">SYNC</div><div style="font-size:12px;color:#C8C8D8;">All your devices</div></div>
      <div style="flex:1;background:#12121E;padding:12px 14px;border-right:1px solid #1E1E2E;"><div style="font-size:8px;color:#E8440A;letter-spacing:0.16em;margin-bottom:4px;text-transform:uppercase;">DOCS</div><div style="font-size:12px;color:#C8C8D8;">Unlimited invoices</div></div>
      <div style="flex:1;background:#12121E;padding:12px 14px;"><div style="font-size:8px;color:#E8440A;letter-spacing:0.16em;margin-bottom:4px;text-transform:uppercase;">EMAIL</div><div style="font-size:12px;color:#C8C8D8;">Send quotes direct</div></div>
    </div>
    <div style="font-size:9px;color:#555;letter-spacing:0.1em;margin-top:14px;text-align:center;">NO CREDIT CARD · NO COMMITMENT · CANCEL ANYTIME</div>
  </div>
</section>
<footer>
