    ...
    <div style={wrap}>
      ...
      {view==="edit"&&editing&&(<div style={pad}>
        ...
        {!isContract&&(<>
          ...
          {markupMode&&(<div style={{background:"#FFF7ED",border:"1px solid #FED7AA",borderRadius:10,padding:"10px 12px",marginBottom:12,fontSize:12,color:"#92400E"}}><strong>Markup mode:</strong> Enter cost price for materials + markup %. Labour uses rate directly.</div>)}
